...
* **⚠️ Deploy GÖZLƏYİR:** SQL `_15` **canlıya tətbiq olundu**, amma **frontend HƏLƏ push EDİLMƏYİB** (istifadəçi təsdiqi gözlənir). Aktiv SQL zənciri: `sql/`-də **_15-ə qədər**. §20-dəki LANSMAN SIFIRLAMA PLANI hələ də gözləyir.
